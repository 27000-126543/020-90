...
function runSimulation() {
  ...
  try {
    ...
    if (fifo.length === 0) {
      html = '<div class="verify-result warn"><h4>⚠️ No Existing Stock</h4>' +
    ...
    if (weeklyUsage <= 0) {
      ...
      html = '<div class="verify-result block">' +
        ...
        '<div class="detail">' +
          ...
          '�?Additional scrap quantity: <strong>' + ((sim.totalScrappedQty || 0) - (simWithoutNew.totalScrappedQty || 0)) + ' ' + unit + '</strong><br>' +
          ...
          '�?Suggested purchase qty: <strong>' + suggestedQtyBlock + ' ' + unit + '</strong> (2-week safety stock)<br>' +
    ...
    resultType = 'warn';
    html = '<div class="verify-result warn">' +
      '<h4>⚠️ Verification Partially Completed</h4>' +
      '<div class="detail">' +
